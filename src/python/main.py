...
def main():
    ...
    print("         CUBE SOLVER         ")
    print("=========================================\n")
    print("IMPORTANT: Start holding the cube neutrally (Front facing camera, Top facing ceiling).")
    print("1. UP    (Tilt the top of the cube towards the camera)")
    print("2. FRONT (Tilt it back to the neutral position)")
    print("3. RIGHT (Rotate the entire cube to the left)")
    print("4. BACK  (Rotate to the left again)")
    print("5. LEFT  (Rotate to the left again)")
    print("6. DOWN  (Rotate left to neutral, then tilt the bottom towards the camera)")
